...
- Document unique d'évaluation des risques professionnels (DUERP) et ses mises à jour annuelles — dès le 1er salarié
...
| | |
|---|---|
| **Minimum légal** | Registre du personnel : 5 ans après le départ du salarié. DUERP : 40 ans (toutes les versions). Accords : durée + 5 ans. Observations de l'inspection : 5 ans. |
| **Recommandé** | Permanent pour les versions du DUERP et du registre du personnel (les exports datés ne pèsent rien). |

Base : Code du travail art. L.1221-13, R.1221-26 (registre), L.4121-3-1 et R.4121-4 (DUERP 40 ans), L.1311-2 (règlement intérieur).
