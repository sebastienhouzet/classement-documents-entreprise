...
Durées **minimales légales** et durées **recommandées** pour ce plan de classement. Quand deux textes s'appliquent,
on retient la plus longue. Le point de départ est la date de clôture (fin du contrat, départ du salarié, clôture
de l'exercice), pas la date du document. Ce tableau est une aide : il ne remplace pas la vérification d'un
professionnel pour une situation particulière.

## Société et juridique

| Document | Minimum légal | Recommandé | Dossier |
|---|---|---|---|
| Statuts, actes constitutifs | 5 ans après la radiation | Permanent | `01.1`, `01.2` |
| PV d'assemblées, registres de décisions, registres de titres | 5 ans après fin d'utilisation | Permanent | `01.3`, `01.4` |
| Feuilles de présence, pouvoirs, rapports de gestion et du CAC | 3 derniers exercices | Avec le PV (permanent) | `01.3` |
| Pacte d'associés, cessions de titres, BSPCE | 5 ans | Permanent | `01.6` |
| Marques, dépôts, cessions de droits | 5 ans après fin de protection | Permanent tant qu'exploité | `01.7` |
| CGV / CGU (chaque version) | 5 ans après le dernier contrat sous cette version (10 ans si électronique ≥ 120 €) | 10 ans après remplacement | `01.8` |
| Contentieux | 5 ans après décision définitive ; 10 ans pour exécuter un jugement | 10 ans ; jugements permanents | `01.9` |

## Contrats

| Document | Minimum légal | Recommandé | Dossier |
|---|---|---|---|
| Contrats commerciaux (clients, fournisseurs, sous-traitance) | 5 ans après la fin (10 ans si conclu par voie électronique ≥ 120 €) | 10 ans après la fin | `02.1` à `02.3` |
| Attestations de vigilance des sous-traitants | 5 ans | 5 ans | `02.2`, `02.3`, `03.9` |
| Baux commerciaux | Durée + 5 ans | 10 ans après la fin | `02.4` |
| Acquisition immobilière | 30 ans | Permanent | `02.4` |
| Abonnements, licences | 5 ans après résiliation | 5 ans | `02.5` |
| NDA | Durée de l'obligation + 5 ans | 10 ans | `02.6` |

## Ressources humaines

| Document | Minimum légal | Recommandé | Dossier |
|---|---|---|---|
| Registre unique du personnel | 5 ans après le départ du salarié | Permanent (exports datés) | `03.1` |
...
| Arrêts de travail, attestations IJSS | 5 ans | 5 ans | `03.7` |
| Déclarations d'accident du travail | 5 ans | 10 ans | `03.8` |
| Documents d'exposition à des risques | 40 ans | 40 ans | `03.8` |
| PV d'élections CSE, PV de carence | 5 ans | Permanent | `03.10` |

## Comptabilité, fiscalité, banque
...
| Document | Minimum légal | Recommandé | Dossier |
|---|---|---|---|
| Correspondance commerciale, courrier | 5 ans | 5 ans ; recommandés 10 ans | `07.2` |
