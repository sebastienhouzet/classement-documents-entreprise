...
| `Tiers` | Nom stable du client, fournisseur, salarié, organisme (le même que le nom de son dossier) | `FournisseurA`, `URSSAF`, `DUPONT-Jean`, `Banque A` |
...
- **Dossiers par tiers** : `Nom du tiers` tel qu'il apparaît sur les contrats, sans forme juridique (`Dupont`, pas `SAS Dupont`). Un salarié : `NOM Prénom`.
