...
| `Tiers` | Nom stable du client, fournisseur, salarié, organisme (le même que le nom de son dossier) | `Client-Alpha`, `URSSAF`, `NOM-Prenom`, `Banque-Alpha` |
...
- `2026-01_Releve.pdf` (dans `05.1/Banque Alpha - Compte courant/Releves/2026/`)
...
- **Dossiers par tiers** : `Nom du tiers` tel qu'il apparaît sur les contrats, sans forme juridique (`Client Alpha`, pas `SAS Client Alpha`). Un salarié : `NOM Prénom`.
