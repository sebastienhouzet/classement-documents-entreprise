...
- Contrats de services généraux du quotidien si non rangés en `02.5` : fontaine à eau, machine à café, ménage, déchets (Tri 7 flux — attestation annuelle)
- Relevés de compteurs, courriers du syndic, incidents (fuite, panne) hors sinistre assuré
- Tri des déchets : attestations de collecte, registre des déchets si applicable
...
Base : Code du travail art. R.4224-17, R.4226-16 et s. ; Code de la construction et de l'habitation art. R.143-44 (ERP).
